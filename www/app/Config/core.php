 ...
 */
	Configure::write('Security.salt', 'DYhG93b0qyJfI456456xfs2guVoUubWwvniR2G0FgaC9mi');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '76859309657453544564564562496749683645');
